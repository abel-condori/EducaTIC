...
public class PermisoDaoImp implements PermisoDao{
    ...
    public Permiso get(int id) {
        ...
        Criteria criteria = sesion.createCriteria(Permiso.class);
        Permiso x = (Permiso) criteria.add(Restrictions.eq("id", id)).uniqueResult();
    ...
    public List<Permiso> findAll() {
        ...
        Criteria criteria = sesion.createCriteria(Permiso.class);
        List<Permiso> lista = (List<Permiso>) criteria.list();
    ...
    public Permiso CriteriaUnique(Map mapa) {
        ...
        Permiso x = (Permiso) criteria.uniqueResult();
