 ...
 * @author Nerio
 */
public class RendimientoDaoImp implements RendimientoDao {
    ...
    public Rendimiento get(int id) {
        ...
        Criteria criteria = sesion.createCriteria(Rendimiento.class);
        Rendimiento x = (Rendimiento) criteria.add(Restrictions.eq("id", id)).uniqueResult();
    ...
    public List<Rendimiento> findAll() {
        ...
        Criteria criteria = sesion.createCriteria(Rendimiento.class);
        List<Rendimiento> lista = (List<Rendimiento>) criteria.list();
    ...
    public Rendimiento CriteriaUnique(Map mapa) {
        ...
        Rendimiento x = (Rendimiento) criteria.uniqueResult();
