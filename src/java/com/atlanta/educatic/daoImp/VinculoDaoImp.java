 ...
 * @author Canelzi
 */
public class VinculoDaoImp implements VinculoDao {
    ...
    public Vinculo get(int id) {
        ...
        Criteria criteria = sesion.createCriteria(Vinculo.class);
        Vinculo x = (Vinculo) criteria.add(Restrictions.eq("id", id)).uniqueResult();
    ...
    public List<Vinculo> findAll() {
        ...
        Criteria criteria = sesion.createCriteria(Vinculo.class);
        List<Vinculo> lista = (List<Vinculo>) criteria.list();
    ...
    public Vinculo CriteriaUnique(Map mapa) {
        ...
        Vinculo x = (Vinculo) criteria.uniqueResult();
